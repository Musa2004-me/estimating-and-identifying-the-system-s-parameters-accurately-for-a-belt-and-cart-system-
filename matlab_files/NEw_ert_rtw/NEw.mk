###########################################################################
## Makefile generated for component 'NEw'. 
## 
## Makefile     : NEw.mk
## Generated on : Mon Dec 16 13:29:56 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/NEw.elf
...
START_DIR                 = C:/Users/abdal/Desktop/New
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/abdal/DOCUME~1/MATLAB/R2023a/ARDUIN~1/ARDUIN~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/NEw.elf
...
DEFINES_STANDARD = -DMODEL=NEw -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_ArduinoEncoder.o MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o xcp_ext_mode.o NEw.o NEw_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/NEw_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/NEw_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
NEw.o : $(START_DIR)/NEw_ert_rtw/NEw.c
	$(CC) $(CFLAGS) -o "$@" "$<"


NEw_data.o : $(START_DIR)/NEw_ert_rtw/NEw_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/NEw_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/NEw_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/NEw_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/NEw_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
